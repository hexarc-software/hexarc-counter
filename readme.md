...
This is a just-for-fun program for tracking views of web pages and display collected stats using 
custom badges from [shields]([https://shields.io/]).
...
Generate a badge view at [shields](https://shields.io/endpoint) using this view stats url.
